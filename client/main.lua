...
AddEventHandler('qb-phone:client:UpdateMessages', function(ChatMessages, SenderNumber, New)
    ...
    if New then
        ...
        if SenderNumber == PhoneData.PlayerData.charinfo.phone then
            PhoneNotify.text = "Kendine mesaj atacak kadar yalnız mısın?"
        end
        SendNUIMessage({
            action = "Notification",
...
AddEventHandler('qb-phone:client:TransferMoney', function(amount, newmoney)
    ...
    SendNUIMessage({ 
        action = "UpdateBank", 
        newBalance = PhoneData.PlayerData.money.bank
    })
end)
...
RegisterNUICallback('TakeImage', function(data, cb)
    ...
    while takePhoto do
        ...
        elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
            exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/931537299437658182/dm9N0K_yAky9Em9lxb5teZ2OajR0yS6o1sH3dM4s7I0_ih9HaJC29J9-WcOg6BXW_zdN", "files[]", function(data)
...
RegisterNUICallback("LockKeyboard", function()
    ...
    while LockKeyboard do
        ...
        DisableControlAction(0, Keys['0'], true)
